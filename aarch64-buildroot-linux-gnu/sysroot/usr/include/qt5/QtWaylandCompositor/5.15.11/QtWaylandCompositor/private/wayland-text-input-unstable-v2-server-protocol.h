...
/**
 * @ingroup iface_zwp_text_input_v2
 * Validate a zwp_text_input_v2 content_hint value.
 *
 * @return true on success, false on error.
 * @ref zwp_text_input_v2_content_hint
 */
static inline bool
zwp_text_input_v2_content_hint_is_valid(uint32_t value, uint32_t version) {
	uint32_t valid = 0;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_NONE;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_AUTO_COMPLETION;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_AUTO_CORRECTION;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_AUTO_CAPITALIZATION;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_LOWERCASE;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_UPPERCASE;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_TITLECASE;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_HIDDEN_TEXT;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_SENSITIVE_DATA;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_LATIN;
	if (version >= 1)
		valid |= ZWP_TEXT_INPUT_V2_CONTENT_HINT_MULTILINE;
...
/**
 * @ingroup iface_zwp_text_input_v2
 * Validate a zwp_text_input_v2 content_purpose value.
 *
 * @return true on success, false on error.
 * @ref zwp_text_input_v2_content_purpose
 */
static inline bool
zwp_text_input_v2_content_purpose_is_valid(uint32_t value, uint32_t version) {
	switch (value) {
...
/**
 * @ingroup iface_zwp_text_input_v2
 * Validate a zwp_text_input_v2 update_state value.
 *
 * @return true on success, false on error.
 * @ref zwp_text_input_v2_update_state
 */
static inline bool
zwp_text_input_v2_update_state_is_valid(uint32_t value, uint32_t version) {
	switch (value) {
	case ZWP_TEXT_INPUT_V2_UPDATE_STATE_CHANGE:
		return version >= 1;
	case ZWP_TEXT_INPUT_V2_UPDATE_STATE_FULL:
		return version >= 1;
	case ZWP_TEXT_INPUT_V2_UPDATE_STATE_RESET:
		return version >= 1;
	case ZWP_TEXT_INPUT_V2_UPDATE_STATE_ENTER:
		return version >= 1;
	default:
		return false;
	}
...
/**
 * @ingroup iface_zwp_text_input_v2
 * Validate a zwp_text_input_v2 input_panel_visibility value.
 *
 * @return true on success, false on error.
 * @ref zwp_text_input_v2_input_panel_visibility
 */
static inline bool
zwp_text_input_v2_input_panel_visibility_is_valid(uint32_t value, uint32_t version) {
	switch (value) {
	case ZWP_TEXT_INPUT_V2_INPUT_PANEL_VISIBILITY_HIDDEN:
		return version >= 1;
	case ZWP_TEXT_INPUT_V2_INPUT_PANEL_VISIBILITY_VISIBLE:
		return version >= 1;
	default:
		return false;
	}
...
/**
 * @ingroup iface_zwp_text_input_v2
 * Validate a zwp_text_input_v2 preedit_style value.
 *
 * @return true on success, false on error.
 * @ref zwp_text_input_v2_preedit_style
 */
static inline bool
zwp_text_input_v2_preedit_style_is_valid(uint32_t value, uint32_t version) {
	switch (value) {
...
/**
 * @ingroup iface_zwp_text_input_v2
 * Validate a zwp_text_input_v2 text_direction value.
 *
 * @return true on success, false on error.
 * @ref zwp_text_input_v2_text_direction
 */
static inline bool
zwp_text_input_v2_text_direction_is_valid(uint32_t value, uint32_t version) {
	switch (value) {
