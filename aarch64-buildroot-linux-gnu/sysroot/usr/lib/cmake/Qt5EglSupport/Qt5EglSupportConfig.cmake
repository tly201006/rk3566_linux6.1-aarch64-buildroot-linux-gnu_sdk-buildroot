...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5EglSupport" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5EglSupport_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5EglSupport_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::EglSupport)
    ...
    set(Qt5EglSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EglSupport_install_prefix}/include/qt5/QtEglSupport/5.15.11"
        "${_qt5EglSupport_install_prefix}/include/qt5/QtEglSupport/5.15.11/QtEglSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EglSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5EglSupport_FIND_VERSION_EXACT}
