...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5QuickShapes" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickShapes_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5QuickShapes_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    set(Qt5QuickShapes_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickShapes_install_prefix}/include/qt5/QtQuickShapes/5.15.11"
        "${_qt5QuickShapes_install_prefix}/include/qt5/QtQuickShapes/5.15.11/QtQuickShapes"
    )
    ...
    foreach(_module_dep ${_Qt5QuickShapes_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5QuickShapes_FIND_VERSION_EXACT}
    ...
    _populate_QuickShapes_target_properties(RELEASE "libQt5QuickShapes.so.5.15.11" "" FALSE)
