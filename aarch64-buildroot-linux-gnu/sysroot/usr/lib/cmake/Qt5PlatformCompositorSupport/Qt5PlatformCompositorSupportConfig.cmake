...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5PlatformCompositorSupport" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5PlatformCompositorSupport_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5PlatformCompositorSupport_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::PlatformCompositorSupport)
    ...
    set(Qt5PlatformCompositorSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PlatformCompositorSupport_install_prefix}/include/qt5/QtPlatformCompositorSupport/5.15.11"
        "${_qt5PlatformCompositorSupport_install_prefix}/include/qt5/QtPlatformCompositorSupport/5.15.11/QtPlatformCompositorSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PlatformCompositorSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5PlatformCompositorSupport_FIND_VERSION_EXACT}
