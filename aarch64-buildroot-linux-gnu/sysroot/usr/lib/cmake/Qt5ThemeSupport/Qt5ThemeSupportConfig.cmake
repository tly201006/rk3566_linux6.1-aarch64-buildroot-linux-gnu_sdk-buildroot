...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5ThemeSupport" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5ThemeSupport_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5ThemeSupport_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::ThemeSupport)
    ...
    set(Qt5ThemeSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5ThemeSupport_install_prefix}/include/qt5/QtThemeSupport/5.15.11"
        "${_qt5ThemeSupport_install_prefix}/include/qt5/QtThemeSupport/5.15.11/QtThemeSupport"
    )
    ...
    foreach(_module_dep ${_Qt5ThemeSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5ThemeSupport_FIND_VERSION_EXACT}
