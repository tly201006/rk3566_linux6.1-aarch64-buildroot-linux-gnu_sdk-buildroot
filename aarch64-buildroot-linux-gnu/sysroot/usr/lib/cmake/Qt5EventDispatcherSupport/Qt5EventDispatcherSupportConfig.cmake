...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5EventDispatcherSupport" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5EventDispatcherSupport_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5EventDispatcherSupport_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::EventDispatcherSupport)
    ...
    set(Qt5EventDispatcherSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EventDispatcherSupport_install_prefix}/include/qt5/QtEventDispatcherSupport/5.15.11"
        "${_qt5EventDispatcherSupport_install_prefix}/include/qt5/QtEventDispatcherSupport/5.15.11/QtEventDispatcherSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EventDispatcherSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5EventDispatcherSupport_FIND_VERSION_EXACT}
