...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5FontDatabaseSupport" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5FontDatabaseSupport_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5FontDatabaseSupport_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::FontDatabaseSupport)
    ...
    set(Qt5FontDatabaseSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5FontDatabaseSupport_install_prefix}/include/qt5/QtFontDatabaseSupport/5.15.11"
        "${_qt5FontDatabaseSupport_install_prefix}/include/qt5/QtFontDatabaseSupport/5.15.11/QtFontDatabaseSupport"
    )
    ...
    foreach(_module_dep ${_Qt5FontDatabaseSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5FontDatabaseSupport_FIND_VERSION_EXACT}
