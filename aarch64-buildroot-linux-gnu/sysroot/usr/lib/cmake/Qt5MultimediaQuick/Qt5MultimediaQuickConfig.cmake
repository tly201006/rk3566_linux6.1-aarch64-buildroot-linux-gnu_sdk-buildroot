...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5MultimediaQuick" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5MultimediaQuick_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5MultimediaQuick_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::MultimediaQuick)
    ...
    set(Qt5MultimediaQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaQuick_install_prefix}/include/qt5/QtMultimediaQuick/5.15.11"
        "${_qt5MultimediaQuick_install_prefix}/include/qt5/QtMultimediaQuick/5.15.11/QtMultimediaQuick"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5MultimediaQuick_FIND_VERSION_EXACT}
    ...
    _populate_MultimediaQuick_target_properties(RELEASE "libQt5MultimediaQuick.so.5.15.11" "" FALSE)
