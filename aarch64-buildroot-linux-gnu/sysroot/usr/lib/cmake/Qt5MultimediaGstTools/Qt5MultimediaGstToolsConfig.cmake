...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5MultimediaGstTools" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5MultimediaGstTools_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5MultimediaGstTools_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::MultimediaGstTools)
    ...
    set(_Qt5MultimediaGstTools_OWN_INCLUDE_DIRS "${_qt5MultimediaGstTools_install_prefix}/include/qt5/" "${_qt5MultimediaGstTools_install_prefix}/include/qt5/QtMultimediaGstTools")
    set(Qt5MultimediaGstTools_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaGstTools_install_prefix}/include/qt5/QtMultimediaGstTools/5.15.11"
        "${_qt5MultimediaGstTools_install_prefix}/include/qt5/QtMultimediaGstTools/5.15.11/QtMultimediaGstTools"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaGstTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5MultimediaGstTools_FIND_VERSION_EXACT}
    ...
    _populate_MultimediaGstTools_target_properties(RELEASE "libQt5MultimediaGstTools.so.5.15.11" "" FALSE)
