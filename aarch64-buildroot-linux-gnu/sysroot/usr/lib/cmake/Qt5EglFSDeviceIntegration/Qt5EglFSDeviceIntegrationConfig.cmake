...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5EglFSDeviceIntegration" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5EglFSDeviceIntegration_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5EglFSDeviceIntegration_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::EglFSDeviceIntegration)
    ...
    set(_Qt5EglFSDeviceIntegration_OWN_INCLUDE_DIRS "${_qt5EglFSDeviceIntegration_install_prefix}/include/qt5/" "${_qt5EglFSDeviceIntegration_install_prefix}/include/qt5/QtEglFSDeviceIntegration")
    set(Qt5EglFSDeviceIntegration_PRIVATE_INCLUDE_DIRS
        "${_qt5EglFSDeviceIntegration_install_prefix}/include/qt5/QtEglFSDeviceIntegration/5.15.11"
        "${_qt5EglFSDeviceIntegration_install_prefix}/include/qt5/QtEglFSDeviceIntegration/5.15.11/QtEglFSDeviceIntegration"
    )
    ...
    foreach(_module_dep ${_Qt5EglFSDeviceIntegration_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5EglFSDeviceIntegration_FIND_VERSION_EXACT}
    ...
    _populate_EglFSDeviceIntegration_target_properties(RELEASE "libQt5EglFSDeviceIntegration.so.5.15.11" "" FALSE)
