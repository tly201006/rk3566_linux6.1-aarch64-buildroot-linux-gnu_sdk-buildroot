...
set(Qt5Gui_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.15.11"
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.15.11/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 drm_atomic;egl;eglfs;kms;eglfs_egldevice;eglfs_gbm;evdev;freetype;system-freetype;fontconfig;gif;harfbuzz;ico;imageio-text-loading;jpeg;libinput;libinput-axis-api;mtdev;multiprocess;png;raster-64bit;system-harfbuzz;system-jpeg;system-png;tslib;tuiotouch;vkgen;vnc;xkbcommon)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 xcb;accessibility-atspi-bridge;dxguid;angle_d3d11_qdtd;direct2d;direct2d1_1;dxgi;direct3d11;direct3d11_1;direct3d9;directfb;dxgi1_2;egl_x11;eglfs_brcm;eglfs_mali;eglfs_openwfd;eglfs_rcar;eglfs_viv;eglfs_viv_wl;vsp2;eglfs_vsp2;xlib;xcb-xlib;eglfs_x11;integrityfb;integrityhid;linuxfb;xkbcommon-x11)
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui.so.5.15.11" "" FALSE)
