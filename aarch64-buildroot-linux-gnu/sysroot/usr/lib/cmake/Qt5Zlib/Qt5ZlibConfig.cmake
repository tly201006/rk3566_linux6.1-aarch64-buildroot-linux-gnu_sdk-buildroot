...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Zlib" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Zlib_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Zlib)
    ...
    set(_Qt5Zlib_OWN_INCLUDE_DIRS "${_qt5Zlib_install_prefix}/include/qt5/" "${_qt5Zlib_install_prefix}/include/qt5/QtZlib")
    ...
    foreach(_module_dep ${_Qt5Zlib_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5Zlib_FIND_VERSION_EXACT}
