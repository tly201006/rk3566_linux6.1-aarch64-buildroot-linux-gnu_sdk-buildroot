...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5QmlDevTools" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QmlDevTools_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5QmlDevTools_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::QmlDevTools)
    ...
    set(Qt5QmlDevTools_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlDevTools_install_prefix}/include/qt5/QtQml/5.15.11"
        "${_qt5QmlDevTools_install_prefix}/include/qt5/QtQml/5.15.11/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5QmlDevTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5QmlDevTools_FIND_VERSION_EXACT}
