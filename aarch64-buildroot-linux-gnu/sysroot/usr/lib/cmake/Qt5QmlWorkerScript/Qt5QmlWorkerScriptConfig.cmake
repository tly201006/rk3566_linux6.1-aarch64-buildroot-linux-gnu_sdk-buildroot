...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5QmlWorkerScript" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QmlWorkerScript_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5QmlWorkerScript_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/qt5/QtQmlWorkerScript/5.15.11"
        "${_qt5QmlWorkerScript_install_prefix}/include/qt5/QtQmlWorkerScript/5.15.11/QtQmlWorkerScript"
    )
    ...
    foreach(_module_dep ${_Qt5QmlWorkerScript_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5QmlWorkerScript_FIND_VERSION_EXACT}
    ...
    _populate_QmlWorkerScript_target_properties(RELEASE "libQt5QmlWorkerScript.so.5.15.11" "" FALSE)
    ...
    macro(_populate_QmlWorkerScript_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QmlWorkerScript_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_QmlWorkerScript_check_file_exists(${imported_location})
