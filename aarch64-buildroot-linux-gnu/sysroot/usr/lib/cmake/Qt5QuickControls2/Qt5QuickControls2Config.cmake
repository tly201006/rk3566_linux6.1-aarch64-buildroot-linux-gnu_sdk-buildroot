...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5QuickControls2" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickControls2_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5QuickControls2_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/include/qt5/QtQuickControls2/5.15.11"
        "${_qt5QuickControls2_install_prefix}/include/qt5/QtQuickControls2/5.15.11/QtQuickControls2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickControls2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5QuickControls2_FIND_VERSION_EXACT}
    ...
    _populate_QuickControls2_target_properties(RELEASE "libQt5QuickControls2.so.5.15.11" "" FALSE)
    ...
    macro(_populate_QuickControls2_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QuickControls2_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickControls2_check_file_exists(${imported_location})
