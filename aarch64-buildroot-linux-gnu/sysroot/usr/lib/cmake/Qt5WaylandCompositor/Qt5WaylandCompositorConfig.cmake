...
set(Qt5WaylandCompositor_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::WaylandCompositor)
    ...
    set(Qt5WaylandCompositor_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandCompositor_install_prefix}/include/qt5/QtWaylandCompositor/5.15.11"
        "${_qt5WaylandCompositor_install_prefix}/include/qt5/QtWaylandCompositor/5.15.11/QtWaylandCompositor"
    )
    ...
    set(_Qt5WaylandCompositor_MODULE_DEPENDENCIES "Gui;Core")
    ...
    foreach(_module_dep ${_Qt5WaylandCompositor_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5WaylandCompositor_FIND_VERSION_EXACT}
    ...
    set(_Qt5WaylandCompositor_LIB_DEPENDENCIES "Qt5::Gui;Qt5::Core")
    ...
    set_property(TARGET Qt5::WaylandCompositor PROPERTY INTERFACE_QT_ENABLED_FEATURES )
    set_property(TARGET Qt5::WaylandCompositor PROPERTY INTERFACE_QT_DISABLED_FEATURES wayland-compositor-quick)
    ...
    set_property(TARGET Qt5::WaylandCompositor
                 ...
                 wayland-server;wayland-datadevice;wayland-dmabuf-client-buffer;wayland-dmabuf-server-buffer;wayland-drm-egl-server-buffer;wayland-egl;wayland-shm-emulation-server-buffer)
    set_property(TARGET Qt5::WaylandCompositor
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 wayland-brcm;wayland-layer-integration-vsp2;wayland-libhybris-egl-server-buffer;wayland-vulkan-server-buffer;xcomposite-egl;xcomposite-glx)
    ...
    _populate_WaylandCompositor_target_properties(RELEASE "libQt5WaylandCompositor.so.5.15.11" "" FALSE)
