...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5QmlModels" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QmlModels_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5QmlModels_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::QmlModels)
    ...
    set(Qt5QmlModels_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlModels_install_prefix}/include/qt5/QtQmlModels/5.15.11"
        "${_qt5QmlModels_install_prefix}/include/qt5/QtQmlModels/5.15.11/QtQmlModels"
    )
    ...
    foreach(_module_dep ${_Qt5QmlModels_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5QmlModels_FIND_VERSION_EXACT}
    ...
    _populate_QmlModels_target_properties(RELEASE "libQt5QmlModels.so.5.15.11" "" FALSE)
    ...
    macro(_populate_QmlModels_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QmlModels_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_QmlModels_check_file_exists(${imported_location})
