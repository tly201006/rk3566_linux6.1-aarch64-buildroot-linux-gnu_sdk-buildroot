...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5WaylandClient" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WaylandClient_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5WaylandClient_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::WaylandClient)
    ...
    set(_Qt5WaylandClient_OWN_INCLUDE_DIRS "${_qt5WaylandClient_install_prefix}/include/qt5/" "${_qt5WaylandClient_install_prefix}/include/qt5/QtWaylandClient")
    set(Qt5WaylandClient_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandClient_install_prefix}/include/qt5/QtWaylandClient/5.15.11"
        "${_qt5WaylandClient_install_prefix}/include/qt5/QtWaylandClient/5.15.11/QtWaylandClient"
    )
    ...
    foreach(_module_dep ${_Qt5WaylandClient_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5WaylandClient_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::WaylandClient
                 ...
                 wayland-brcm;wayland-libhybris-egl-server-buffer;wayland-vulkan-server-buffer;xcomposite-egl;xcomposite-glx)
    ...
    _populate_WaylandClient_target_properties(RELEASE "libQt5WaylandClient.so.5.15.11" "" FALSE)
    ...
    macro(_populate_WaylandClient_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5WaylandClient_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_WaylandClient_check_file_exists(${imported_location})
