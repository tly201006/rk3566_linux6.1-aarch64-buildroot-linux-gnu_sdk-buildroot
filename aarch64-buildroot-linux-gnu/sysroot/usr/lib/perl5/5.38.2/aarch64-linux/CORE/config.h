 ...
 */
#define ARCHLIB "/usr/lib/perl5/5.38.2/aarch64-linux"		/**/
#define ARCHLIB_EXP "/usr/lib/perl5/5.38.2/aarch64-linux"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB "/usr/lib/perl5/5.38.2"		/**/
#define PRIVLIB_EXP "/usr/lib/perl5/5.38.2"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/lib/perl5/site_perl/5.38.2/aarch64-linux"		/**/
#define SITEARCH_EXP "/usr/lib/perl5/site_perl/5.38.2/aarch64-linux"		/**/
 ...
 */
#define SITELIB "/usr/lib/perl5/site_perl/5.38.2"		/**/
#define SITELIB_EXP "/usr/lib/perl5/site_perl/5.38.2"		/**/
...
#define PERL_TARGETARCH	"aarch64-buildroot-linux-gnu"	/**/
#endif
